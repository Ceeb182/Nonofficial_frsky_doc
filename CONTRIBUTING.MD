...
--------------------------------------------------------------------------------------
<a name="FR_Section"></a>![<MERCI>](_media/Logo-ThanksFR.png "Merci")

*Tout d'abord, merci pour le temps que vous donnez pour contribuer à l'amélioration des documents présents sur ce dépot !*

--------------------------------------------------------------------------------------

### ![<*>](_media/Logo-UnderConstruction25x22.png) CE DOCUMENT EST EN CONTRUCTION ![<*>](_media/Logo-UnderConstruction25x22.png)
...
<a name="FR_COC"></a>
## ![>](_media/Logo-PuceTriJN.png) Charte Code de Conduite Contributeurs
...
<a name="FR_Patient"></a>
## ![>](_media/Logo-PuceTriJN.png) Soyez patient et indulgent
...
**Aussi, je vous remercie par la patience et l'indulgence dont vous ferez preuve à mon égard.**
...
<a name="FR_Wish"></a>
## ![>](_media/Logo-PuceTriJN.png) Demander une traduction particulière
...
<a name="FR_Issue"></a>
## ![>](_media/Logo-PuceTriJN.png) Vérifier et corriger les traductions déjà réalisées
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)

1. **Avant de signaler un problème** sur un document déjà réalisé, veuillez vérifier que ce problème n'a pas déjà été déclaré. Pour le vérifier, cliquez sur l'onglet `Issue` et tapez dans le champ de recherche :
   * le nom complet du fichier concerné
   * le paragraphe concerné
   
   Dans les résultats de recherche, vérifier que ce problème n'a pas déjà été déclaré.

2. **Si le problème n'a pas été déclaré**, cliquez sur le bouton `New issue`.
   Indiquer dans le titre *le nom complet* du fichier concerné ET le sujet que vous voulez aborder, commme par exemple `X8R-Manuel utilisateur-vFr5.PDF / Corrections à apporter`  

   Afin que le correcteur puisse retrouver les éléments à modifier, pour chaque erreur indiquez :
   * Le nom du paragraphe concerné, par exemple `SECTION = "What's new"`
   * L'erreur avec un numéro d'ordre suivi du type. Le type peut être :
     - `TEXT` pour du texte
     - `DRAWING` pour les erreurs graphiques (schémas et dessins)
     - `LAYOUT` pour la mise en page
   * Préciser l'erreur et sa proposition de correction
   * Séparer chaque erreur par un trait hotizontal : `-----------------`
   
   Pour l'exemple, on peut ainsi écrire dans le corps du message :
     ```
     SECTION = "What's new"
     E01.TEXT = Modifier "pour ce récepteur" par "pour les récepteurs du type X8R, X6R..."
     E02.LAYOUT = Mauvaise position du second paragraphe
     ------------------------------------------------------
     SECTION = "Specifications"
     E03.DRAWING = Connecteur "IN" avec le mauvais nombre de broche
     ```
      
   Eventuellement, vous pouvez joindre un fichier SVG source avec les modifications apportées entourées par une élipse dont le contour est **rouge**.
...
<a name="FR_TxtOnly"></a>
## ![>](_media/Logo-PuceTriJN.png) Proposer de nouvelles traductions littérales sans m'occuper de la mise en page
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
<a name="FR_Drawing"></a>
## ![>](_media/Logo-PuceTriJN.png) Proposer une partie graphique du document (dessin, schéma,...) au format SVG
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
## ![>](_media/Logo-PuceTriJN.png) Proposer une traduction intégrale tant sur le fond que sur la forme
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
## ![>](_media/Logo-PuceTriJN.png) Proposer le travail actuel dans d'autres langues
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
<a name="FR_Plus"></a>
## ![>](_media/Logo-PuceTriJN.png) Mettre à disposition du contenu permettant la création des versions "`Plus`" ou "`Inédites`"
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
## ![>](_media/Logo-PuceTriJN.png) Opérations avec Git et GitHub
### ![<*>](_media/Logo-UnderConstruction25x22.png) En construction ![<*>](_media/Logo-UnderConstruction25x22.png)
*La gestion du flux de travail est très largement inspirée du projet [OpenTx](https://github.com/opentx/opentx/wiki/Github-issue-workflow).*
  >   ![>](_media/Logo-warning.png) **IMPORTANT :**  
...
*CONTRIBUTING.MD / Mis à jour 26-09-2017*
<BR>
<BR>
<BR>

--------------------------------------------------------------------------------------
<a name="EN_Section"></a>![<THANKS>](_media/Logo-ThanksEN.png "Thanks")
...
### ![<*>](_media/Logo-UnderConstruction25x22.png) THIS DOCUMENT IS UNDER CONTRUCTION ![<*>](_media/Logo-UnderConstruction25x22.png)
...
<a name="EN_COC"></a>
## ![>](_media/Logo-PuceTriJN.png) Code of Conduct Charter
...
<a name="EN_Patient"></a>
## ![>](_media/Logo-PuceTriJN.png) Be patient and indulgent
...
<a name="EN_Wish"></a>
## ![>](_media/Logo-PuceTriJN.png) Ask for a specific translation
...
<a name="EN_Issue"></a>
## ![>](_media/Logo-PuceTriJN.png) Check and correct already translated documents
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)

1. **Before reporting an issue** on an existing document, make sure that this issue has not already been reported. To check it, click on the `Issue` tab and type in the search field:
   * the full name of the file concerned
   * the relevant paragraph
   
   In the search results, verify that this issue has not already been reported.

2. **If the issue** has not been reported, click the `New issue` button.
   Indicate in the title the **full name** of the file concerned AND the topic you want to address, such as `X8R-User Manual-vFr5.PDF / Corrections to be brought`.  

   So that the corrector can find the elements to modify, for each error indicate:
   * The section name concerned, for example `SECTION = "What's new"`
   * The error with a serial number followed by the type. The type can be :
     - `TEXT` for text
     - `DRAWING` for graphical errors (diagrams and drawings)
     - `LAYOUT` for layout
   * Specify the error and its correction proposal
   * Separate each error by a horizontal line: `-----------------`
   
   For the example, we can write in the body of the message:
     ```
     SECTION = "What's new"
     E01.TEXT = Edit "for receiver" into "for receiver like : X8R, X6R..."
     E02.LAYOUT = Wrong position in second paragraph
     ------------------------------------------------------
     SECTION = "Specifications"
     E03.DRAWING = "IN" plug with the wrong number of pin
     ```
      
   Optionally, you can attach a source SVG file with the changes made surrounded by an elipse whose outline is **red**.
...
<a name="EN_TxtOnly"></a>
## ![>](_media/Logo-PuceTriJN.png) Propose new literal translations without taking care of the layout
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
2. **Case 2 - I know how to use Git and GitHub**  
   You can propose the file(s) of your literal translation by performing a `Pull request` from your branch to the `Next_release` branch, as described in **[Git and GitHub workflow](#FR_Workflow)**.


<a name="EN_Drawing"></a>
## ![>](_media/Logo-PuceTriJN.png) Propose a graphical part of the document (drawing, diagram, ...) in SVG format
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
2. **Case 2 - I know how to use Git and GitHub**  
   You can propose the SVG file(s) by performing a `Pull request` from your branch to the `Next_release` branch, as described in **[Git and GitHub workflow](#FR_Workflow)**.


<a name="EN_Integral"></a>
## ![>](_media/Logo-PuceTriJN.png) Propose a complete translation both on the substance and on the form
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
Propose this file set by performing a `Pull request` from your branch to the `Next_release` branch, as described in **[Git and GitHub workflow](#FR_Workflow)**.


<a name="EN_TranslateOL"></a>
## ![>](_media/Logo-PuceTriJN.png) Propose the current work in other languages
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
2. **Case 2 - I know how to use Git and GitHub**  
  You can propose the translation(s) in SVG format by performing a `Pull request` from your branch to the `Next_release` branch, as described in **[Git and GitHub workflow](#FR_Workflow)**.  


<a name="EN_Plus"></a>
## ![>](_media/Logo-PuceTriJN.png) Make content available for creating "`Plus`" or "`Unpublished`"
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
...
2. **Case 2 - I know how to use Git and GitHub**  
   You can propose the additional information by performing a `Pull request` from your branch to the `Next_release` branch, as described in **[Git and GitHub workflow](#FR_Workflow)**.  


<a name="EN_Workflow"></a>
## ![>](_media/Logo-PuceTriJN.png) Git and GitHub workflow
### ![<*>](_media/Logo-UnderConstruction25x22.png) Under construction ![<*>](_media/Logo-UnderConstruction25x22.png)
*This workflow is largely inspired by the [OpenTx](https://github.com/opentx/opentx/wiki/Github-issue-workflow) project*
  >   ![>](_media/Logo-warning.png) **WARNING :**  
...
*CONTRIBUTING.MD / Updated 26-09-2017*
<BR>
<BR>